...
class SalesChartWidget extends PureComponent {
  render() {
    ...
    return (
      <PapperBlock whiteBg noMargin title="Grade Point" icon="ios-stats-outline" desc="">
            ...
            <ul className={classes.bigResume}>
              <li>
                ...
                <Typography variant="h6">
                  <span className={classes.indigoText} />
              ...
              <div className={classes.chartFluid}>
                <ResponsiveContainer>
                  ...
                  >
                    ...
                    <CartesianAxis />
                    <Tooltip />
                    <Bar dataKey="Chemistry" fill={color.primary} />
                    <Bar dataKey="Math" fill={color.secondary} />
                    <Bar dataKey="Physic" fill={color.third} />
                    <Bar dataKey="Literature" fill={color.fourth} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>

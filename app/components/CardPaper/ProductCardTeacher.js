...
class ProductCardTeacher extends React.Component {
  render() {
    const {
      classes,
      discount,
...
ProductCardTeacher.defaultProps = {
  discount: '',
  soldout: false,
  prevPrice: 0,
  list: false,
...
const ProductCardResponsive = withWidth()(ProductCardTeacher);

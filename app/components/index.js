...
export ProductCardTeacher from './CardPaper/ProductCardTeacher';
export ProductCardStudent from './CardPaper/ProductCardStudent';
...
export ProductStudentQuiz from './Product/ProductStudentQuiz';

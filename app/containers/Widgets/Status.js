...
import EditableCellTeacherQuiz from './EditableCellTeacherQuiz';
      ...
      <div>
        ...
        <Grid container spacing={24}>
          <Grid item md={12} xs={12}>
            <PapperBlock title="Calendar" icon="ios-clock-outline" desc="Check your plans & set new targets">

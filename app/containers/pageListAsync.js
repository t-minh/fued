...
export const Assessment = loadable(() => import("./Pages/Assessment"), {
  fallback: <Loading />,
});
export const StudentQuiz = loadable(() => import("./Pages/StudentQuiz"), {
  fallback: <Loading />,
});
export const Resources = loadable(() => import("./Pages/Resources"), {
  fallback: <Loading />,
});

    ...
    return (
      <Dashboard history={history} changeMode={changeMode}>
        <Switch>
          ...
          <Route path="/app/pages/assessment" component={Assessment} />
          <Route path="/app/student/quiz" component={StudentQuiz} />
          <Route path="/app/pages/resources" component={Resources} />
